...
class ImageUploadHandler {
    ...
    {
        //构建存储的文件夹规则，值如：uploads/images/avatars/201905/24/
        //文件切割能让查询效率更高
        $folder_name = "uploads/images/$folder/" . date('Y-md', time());

        //文件具体存储的物理路径，'public_path()' 获取的是public文件的物理路径
        //值如：/home/vagrant/code/spring/public/uploads/images/avatars/201905/24/
