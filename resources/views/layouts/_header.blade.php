    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="{{ active_class(if_route('categories.show') && if_route_param('category', 1)) }}"><a href="{{ route('categories.show', 1) }}">万花园</a></li>
                <li class="{{ active_class(if_route('categories.show') && if_route_param('category', 2)) }}"><a href="{{ route('categories.show', 2) }}">技巧</a></li>
